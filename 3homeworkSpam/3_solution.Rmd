...
color[log(remove) < log(0.055) & log(punc_dollar) < log(0.0555)] = 'orange'
plot(log(remove),log(punc_dollar),xlab='log(remove)',ylab='log(punc_dollar)',cex=.4,col=color)
abline(h = log(0.0555))#punc_dollar
segments(x0 = log(0.055), y0 = -10, y1 = log(0.0555))#remove
